					...
					<tbody>
						<c:forEach items="${pager.list}" var="item">
							<tr>
								...
								<td><a
									href="<%=basePath%>sys/subject?cmd=toedit&id=${item.sid}">编辑</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
				...
				<div class="pagination pagination-right">
					<ul>
						...
						<li><c:if test="${pager.pagectrl.currentindex==1}" var="fp">
								...
								<a
									href="<%=basePath%>sys/subject?cmd=list&index=${pager.pagectrl.currentindex-1}">上一页</a>
							</c:if></li>
						...
						<li><c:if
								...
								<a
									href="<%=basePath%>sys/subject?cmd=list&index=${pager.pagectrl.currentindex+1}">下一页</a>
							</c:if></li>
					</ul>
				</div>
			</div>
