		...
		<div class="row-fluid">
			<form class="form-inline" method="post"
				...
				<input class="input-xlarge" placeholder="功能名称..." name="sname"
					...
					href="<%=basePath%>sys/function/add.jsp?pid=-1&pname=无"> <i
					class="icon-plus"></i> 新建顶层功能
				</a>
			</form>
					...
					<tbody>
						<c:forEach items="${pager.list}" var="item">
							<tr>
								...
								<td><a
									href="<%=basePath%>sys/fun?cmd=toedit&id=${item.funid}">编辑</a>
									&ensp; <a
									href="<%=basePath%>sys/function/add.jsp?pid=${item.funid}&pname=${item.funname}">子功能</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
