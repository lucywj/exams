					...
					<tbody>
						<c:forEach items="${pager.list}" var="item">
							<tr>
								...
								<td><a
									href="<%=basePath%>sys/paper?cmd=slist&pname=${item.pname}">查看试题</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
				...
				<div class="pagination pagination-right">
					<ul>
						...
						<li><c:if test="${pager.pagectrl.currentindex==1}" var="fp">
								...
								<a
									href="<%=basePath%>sys/paper?cmd=list&index=${pager.pagectrl.currentindex-1}">上一页</a>
							</c:if></li>
						...
						<li><c:if
								...
								<a
									href="<%=basePath%>sys/paper?cmd=list&index=${pager.pagectrl.currentindex+1}">下一页</a>
							</c:if></li>
					</ul>
				</div>
			</div>
